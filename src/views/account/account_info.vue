    ...
    <el-card class="container">
      ...
      <el-form ref="form" :rules="rules" :model="account" label-width="100px" label-position="left" class="subform">
        ...
        <el-form-item label="姓名" prop="account_name">
          <el-input v-model="account.account_name" placeholder="请输入姓名" disabled></el-input>
        </el-form-item>
        <!--    性别    -->
        <el-form-item label="性别" prop="account_sex">
          <div class="flex__start">
            <el-radio-group v-model="account.account_sex" disabled>
        ...
        <el-form-item label="手机" prop="account_phone">
          <el-input v-model="account.account_phone" placeholder="请输入手机号" disabled></el-input>
        </el-form-item>
        <el-form-item label="所属场馆" prop="account_belong_venus">
          <div class="flex__start">
            <el-select v-model="account.account_belong_venus" placeholder="请所属场馆" style="width: 100%" disabled>
              <el-option
        ...
        <el-form-item label="身份" prop="account_identity_id">
          <div class="flex__start">
            <el-select v-model="account.account_identity_id" placeholder="请所属场馆" style="width: 100%" disabled>
              <el-option
                  v-for="(item, index) in venusList"
                  :key="index"
                  :label="item.venue_name"
        ...
        <el-form-item label="排序">
          <el-input v-model="account.account_sort" disabled></el-input>
        </el-form-item>
        <el-form-item label="签名">
          <el-input v-model="account.account_autograph"
                    :rows="4"
                    type="textarea"
                    placeholder="请输入签名" disabled/>
        </el-form-item>
        <el-form-item label="是否展示">
          <el-switch
              ...
              active-color="#13ce66"
              inactive-color="#cccccc" disabled>
          </el-switch>
        </el-form-item>
      ...
      <el-form ref="form" :rules="rules" :model="account" label-width="100px" label-position="left" class="subform">
        ...
        <el-form-item label="用户名" v-if="account.account_allow_login">
          <el-input
              ...
              placeholder="请输入用户名"
              v-model="account.user_name" disabled>
          </el-input>
        </el-form-item>
        <el-form-item label="密码" v-if="account.account_allow_login" disabled>
          <el-input
