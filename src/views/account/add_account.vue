  ...
  methods:{
    ...
    getAccountInfo(){
      ...
      GetAccountInfo(params).then(res=>{
        this.account.account_header_img = res.data.account_header_img;
        this.account.account_name = res.data.account_name;
        this.account.account_sex = res.data.account_sex;
        this.account.account_phone = res.data.account_phone;
        this.account.account_belong_venus = res.data.account_belong_venus
      })
    },
    submitForm(){
